...
const LogoContainer = styled.div`
  ...
  /* --- 3D / SPHERICAL STYLES START --- */

  /* 1. Radial Gradient for Light Source Simulation */
  background: radial-gradient(
    circle at 35% 35%,
    #D4E1F7 50%, /* Bright white highlight near top-left */
    #8EACEB 90%, /* Light-medium color */
    #263EA1 90% /* Darker color at the edge */
  );
  ...
  &::before {
    ...
    /* Using a subtle, darker gradient for the aura/glow */
