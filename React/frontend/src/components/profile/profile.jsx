    ...
    <div className="flex justify-center items-center min-h-full w-full">
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 gap-12">
            <div className="space-y-3">
              ...
              <Input id="name" placeholder="Your Name" className="h-10 border-gray-300 rounded-md" />
            </div>
            <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-12">
            <div className="space-y-3">
              ...
              <Input id="dateJoined" placeholder="14/5/2025" className="h-10 border-gray-300 rounded-md" />
            </div>
            <div className="space-y-3">
              <Label htmlFor="role" className="text-sm font-medium text-gray-700">
                Role
              </Label>
              <Input id="role" placeholder="Your Role" className="h-10 border-gray-300 rounded-md" />
            </div>
          </div>
        </div>

        {/* Toggle Switches - Added more margin */}
            ...
            <div className="relative">
              ...
              <label htmlFor="darkMode" className="flex items-center cursor-pointer">
                <div className="relative">
                  ...
                  ></div>
                  <div
                    className={`absolute w-5 h-5 bg-white rounded-full shadow top-0.5 transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex justify-center pt-1">
          <Button className="w-32 h-12 bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-md">Save</Button>
        </div>
      </div>
    </div>
  )
