        ...
        for p in pieces:
            ...
            if re.match(r"^\d", p):
                ...
                if base_letters:
                    ...
                    inst = p  # Just use the piece as-is if no base letters
            else:
                inst = p
